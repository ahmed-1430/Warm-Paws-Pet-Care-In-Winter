                ...
                <div className="card-body">
                  ...
                  <div className="flex items-center">
                    <div className="rating rating-sm">
                      {[...Array(5)].map((_, i) => (
                        <input
                          key={i} type="radio" name={`rating-${service.serviceId}`}
                          className="mask mask-star-2 bg-orange-400"
                          checked={i < Math.floor(service.rating)} readOnly
                        />
                      ))}
                    </div>
                  ...
                  <div className="card-actions justify-end">
                    <Link
                      to={`/services/category/${service._id}`} className="btn btn-primary btn-sm"> View Details </Link>
                  </div>
                </div>
              </div>
            ))}
